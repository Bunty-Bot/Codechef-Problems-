...
#   Note that the i-th menu has the price 2i-1 (1 ≤ i ≤ 12). Since Tomya is a pretty girl, she cannot eat a lot. So please find the minimum 
#   number of menus whose total price is exactly p. Note that if she orders the same menu twice, then it is considered as two menus are ordered. 
...
# This is the code for Ciel and Receipt problem. This is one of the complex problems for the beginner. If you understand what we have to do in the 
# then it is very easy question. But you have to read this question 2-3 times for better understanding.
